...
export const userAuthStore = create((set) =>({
    ...
    signup:async(email,password,username,role) => {
        ...
        try{
            const response = await axios.post(`${API_URL}/signup`,{email,password,username,type:role});
            set({user:response.data.userData,isAuthenticated:true,isLoading:false});
...
//   if (!isCheckingAuth) return;
        ...
        try {
            ...
            set({user: response.data.userData, isAuthenticated: true, isCheckingAuth: false});
        }catch (error) {
    ...
    forgotPassword :async(email) => {
        ...
        set({isLoading:true,error:null});
         console.log("Forgot password email--response:",email);
        try{
