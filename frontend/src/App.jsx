...
const checkAuth = userAuthStore((state) => state.checkAuth);
  ...
  return (
    ...
    <FloatingShape color="bg-yellow-300" size='w-64 h-64' top="-5%" left="10%" delay={0} />
    <FloatingShape color="bg-slate-100" size='w-48 h-48' top="70%" left="0%" delay={5} />
    <FloatingShape color="bg-yellow-300" size='w-48 h-48' top="10%" left="70%" delay={1} />
    <FloatingShape color="bg-slate-400" size='w-48 h-48' top="80%" left="60%" delay={3} />
    <FloatingShape color="bg-yellow-100" size='w-48 h-48' top="17%" left="90%" delay={2} />
    <FloatingShape color="bg-slate-50" size='w-64 h-64' top="60%" left="60%" delay={6} />
    <FloatingShape color="bg-yellow-200" size='w-32 h-32' top="40%" left="-10%" delay={2} />
    ...
    <Routes>
      ...
      <Route path='/profile' element={
         <RedirectAuthenticatedUser>
        <Profile/> </RedirectAuthenticatedUser>} />
