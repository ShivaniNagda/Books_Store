  ...
  const {verifyEmail} = userAuthStore();
        ...
        const handleChange = (index,value) =>{
            const newCode = [...code];
                ...
                console.log("NewCode before change:",newCode);
  ...
  return (
    ...
    <div className='max-w-md w-full bg-gray-800 bg-opacity-50 bachdrop-filter backdrop-blur-xl rounded-2xl shadow-xl overflow-hidden p-4 '>
      ...
      className="max-w-md w-full bg-gray-800 bg-opacity-50 bachdrop-filter backdrop-blur-xl rounded-2xl shadow-xl overflow-hidden" >
            ...
            <h2 className="text-3xl font-bold mb-6 text-center bg-gradient-to-r from-yellow-400 to-yellow-500 text-transparent bg-clip-text" >Verify Your Email</h2>
            ...
            <form onSubmit={handleSubmit} className='space-y-6' >
              ...
              <motion.button className="mt-5 w-full py-3 px-4 bg-gradient-to-t from-yellow-500 to-yellow-600 text-white font-bold
              rounder-lg shadow-lg hover:from-yellow-300 hover:to-yellow-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-gray-900 transition duration-200 "
