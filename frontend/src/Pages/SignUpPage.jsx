  ...
  return (
    ...
    <motion.div
      ...
      className="max-w-md w-full bg-gray-800 bg-opacity-50 bachdrop-filter backdrop-blur-xl rounded-2xl shadow-xl overflow-hidden" >
        <div className="p-8">
            <h2 className="text-3xl font-bold mb-6 text-center bg-gradient-to-r from-yellow-300 to-yellow-400 text-transparent bg-clip-text" >Create Account</h2>
            <form onSubmit={handleSignUp}>
                ...
                <Select  icon={BookOpenCheck}  value={role} roles={["Customer","Admin","Seller"]} onChange={(e)=> setRole(e.target.value)} />
              ...
              rounder-lg shadow-lg hover:from-yellow-300 hover:to-yellow-600 focus:outline-none focus:ring-2 focus:ring-slate-50 focus:ring-offset-2 focus:ring-offset-gray-900 transition duration-200 "
        ...
        <div className="px-8 py-4 bg-gray-900 bg-opacity-50 flex justify-center ">
          <p className="text-sm text-gray-400">
            ...
            <Link to={"/login"} className="text-zinc-50 hover:underline" >Login</Link>
          </p>
        </div>
